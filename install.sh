#!/usr/bin/env sh
# Universal installer for sigsurvey-rf. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/sigsurvey-rf.git"
echo "Installing sigsurvey-rf ..."
...
echo "Done. Run: sigsurvey-rf --help"
