"""Native cognis-connect emit for sigsurvey-rf — forward findings to any platform.

Maps sigsurvey-rf's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    sigsurvey-rf ... --format json | sigsurvey-rf-emit --to stix
    sigsurvey-rf-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
